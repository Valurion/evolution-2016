...
<div id="body-content">
    <div id="free_text">
        ...
        <p>
            ...
            mois. <br>   Pour
            consulter votre crédit d'articles, acheter un crédit ou activer une
            carte prépayée, vous devez disposez d'un compte Cairn.info. </p>

        <p>Si vous disposez d'un compte Cairn.info, identifiez-vous&nbsp;: <a class="acceder link_custom_generic" href="./connexion.php?connectFrom=creditArticle">S’identifier</a></p>
