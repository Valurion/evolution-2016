<!--
    Il faut fournir à cette vue:
        ...
        - $urlParamName = valeur du nom du paramètre de l'URL (par défaut = LIMIT)
...
-->
<?php
// Définition de la valeur du nom du paramètre de l'URL (par défaut = LIMIT)
$urlGetParameter = "LIMIT";
if($urlParamName) { $urlGetParameter = $urlParamName; }
        ...
        <ul>
            ...
            if ($currentPage != 1) {
                if (!isset($urlPager) || $urlPager == '') {
                    ...
                    ?>
                    <li class="prev"><a href="<?php echo $urlPager; ?>&amp;<?=$urlGetParameter; ?>=<?php echo $limit - $nbPerPage; ?>">Précédent</a></li>
                    <li class="first"><a href="<?php echo $urlPager; ?>&amp;<?=$urlGetParameter; ?>=0">1</a></li>
                    <?php
                }
            }
            ...
            for ($i = 0; $i < $nbBefore; $i++) {
                if (!isset($urlPager) || $urlPager == '') {
                    ...
                    ?> 
                    <li class="nb"><a href="<?php echo $urlPager; ?>&amp;<?=$urlGetParameter; ?>=<?php echo $limit - (($nbBefore - $i) * $nbPerPage) ?>"><?php echo $currentPage - ($nbBefore - $i); ?></a></li>                
                    <?php
                }
            }
            ?>
            ...
            for ($i = 0; $i < $nbAfter; $i++) {
                if (!isset($urlPager) || $urlPager == '') {
                    ...
                    ?>
                    <li class="nb"><a href="<?php echo $urlPager; ?>&amp;<?=$urlGetParameter; ?>=<?php echo $limit + (($i + 1) * $nbPerPage) ?>"><?php echo $currentPage + ($i + 1); ?></a></li>                
                    <?php
                }
            }
            ...
            if ($currentPage != $lastPage) {
                if (!isset($urlPager) || $urlPager == '') {
                    ...
                    ?>
                    <li class="last"><a href="<?php echo $urlPager; ?>&amp;<?=$urlGetParameter; ?>=<?php echo ($lastPage - 1) * $nbPerPage ?>"><?php echo $lastPage; ?></a></li>
                    <li class="next"><a href="<?php echo $urlPager; ?>&amp;<?=$urlGetParameter; ?>=<?php echo $limit + $nbPerPage; ?>">Suivant</a></li>
                        <?php
                    }
                }
                ?>
