<?php
    ...
    $citation_label = "";
    $array_label    = array(
                        "numero"    => array("ouvrage" => "cet ouvrage", "encyclopedie" => "cet ouvrage"),
                        "article"   => array("ouvrage" => "ce chapitre", "encyclopedie" => "ce chapitre", "encyclopédie" => "ce chapitre", "revue" => "cet article", "magazine" => "cet article")
                      );
...
<div id="modal_citation" class="window_modal" style="display:none;">    
    <div class="info_modal"><a class="close_modal" href="javascript:void(0);" onclick="cairn.close_modal();"></a>
        <div class="citation">
            <h2>Citer <?php echo $citation_label; ?></h2>
            <table class="format">
                <tr>
                    <th>ISO 690</th>
                    <td>
            ...
            <h2>Exporter la citation</h2>

            <ul class="text-center">
                <li><a href="http://www.refworks.com/express/ExpressImport.asp?vendor=Cairn&amp;filter=Refworks%20Tagged%20Format&amp;encoding=65001&amp;url=<?= Configuration::get('refworks') ?>?t=uniq&ID_ARTICLE=<?php echo $export_id_article; ?>">RefWorks</a></li>
                <li><a href="<?= Configuration::get('zotero') ?>?t=uniq&ID_ARTICLE=<?php echo $export_id_article; ?>">Zotero <span>(.ris)</span></a></li>
                <li><a href="<?= Configuration::get('endnote') ?>?t=uniq&ID_ARTICLE=<?php echo $export_id_article; ?>">EndNote <span>(.enw)</span></a></li>
            </ul>
        </div>
    </div>
</div>
