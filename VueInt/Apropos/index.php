...
<div id="body-content">
    <div id="free_text">
        ...
        <h1 class="page-title"><a id="cairn"></a>About Cairn</h1>
        <br>
        <br>
        <div class="form_table w100">
            <div class="form_cell w60 pr2 inbl">


                <p class="general-p inbl justify">
                ...
                <p class="general-p inbl justify">
                    In 2015, more than 400 journals and 5 000 eBooks (representing over 200 000 articles/chapters) from major French, Belgian and Swiss publishers can be accessed by students, scholars and librarians worldwide on <a href="<?= Service::get('ParseDatas')->getCrossDomainUrl(); ?>">www.cairn.info</a>.
                </p>
                <p class="general-p inbl justify">
                    To make this invaluable content accessible to a <span style="white-space:nowrap;">non–francophone</span> readership, Cairn.info launched Cairn International Edition, an English-language platform where abstracts and selected articles from key journals on Cairn.info are translated from French into English, enabling users to search, browse and read this content without speaking a word of French.
                </p>
                <p class="general-p inbl justify">
