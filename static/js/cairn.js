...
/****************************************************************************
 * Sur base du modal, ci-dessus, création d'un MODAL pour le LOGIN
 ***************************************************************************/
cairn.show_login_modal = function() {
    $('#whiteground').fadeIn();
    $('#modal-login').fadeIn();
    $('.user-not-connected').addClass('active');
}

cairn.close_login_modal = function() {
    $('#modal-login').fadeOut();
    $('#whiteground').fadeOut();
    $('.user-not-connected').removeClass('active');
}
/****************************************************************************
 * Fin du modal login
 * **************************************************************************/
